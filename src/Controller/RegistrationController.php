...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordEncoderInterface $passwordEncoder, GuardAuthenticatorHandler $guardHandler, DefaultAuthenticator $authenticator): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->emailVerifier->sendEmailConfirmation('app_verify_email', $user,
                (new TemplatedEmail())
                    ->from(new Address('devtest44444@gmail.com', 'Register Guard'))
                    ->to($user->getEmail())
    ...
    /**
     * @Route("/register/confirm-email", name="email_confirm")
     */
    public function pleaseConfirmYourEmail(){
        return $this->render('registration/pleaseConfirmYourEmail.html.twig');
    }
